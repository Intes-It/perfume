  ...
  return (
    <Container>
        <div className="flex flex-col items-center justify-between text-center h-[220px] mt-[100px]">
          <div className="text-[#6A5950] text-[30px]">Cette page ne semble pas exister.</div>
          <div className="text-[#603813] text-[24px] lg:w-[900px] font-semibold">
            Il semble que le lien pointant ici soit défectueux. Et si vous essayiez
            plutôt de rechercher ?
          </div>
          ...
          <svg className="text-gray-600 h-4 w-4 m-5 fill-current" xmlns="http://www.w3.org/2000/svg"
