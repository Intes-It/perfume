  ...
  return (
    <Container>
      <div className="flex flex-col justify-between items-center text-[20.8px] text-[#383E42] mobile:text-[16px] ">
        <div id="apropos" className=" flex flex-col lg:flex-row justify-between text-justify bg-[#F9F4EE] lg:mt-[100px] mt-[50px] w-[100vw] ">
        ...
        <div id="RALC" className=" flex justify-between flex-col-reverse lg:flex-row text-justify bg-[#F7F7F7] lg:mt-[100px] mt-[50px] w-[100vw] ">
          <div className="lg:w-[48%] mobile:mx-5 mx-10">
            <div className="text-center text-[44.8px] mobile:text-[25.6px] font-bold text-[#383E42]">
              <h2>Rencontre</h2>
