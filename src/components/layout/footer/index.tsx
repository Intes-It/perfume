...
import { FooterRoutes } from "src/constance";
  ...
  return (
    <div className="h-fit bg-[#eff7cf]">
      <div className="grid grid-cols-1 lg:grid-cols-4 py-14">
        ...
        <div className="mx-auto grid col-span-3  md:grid-cols-3 lg:grid-cols-3">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="grid">
                {category?.items?.map((item) => (
                  <a
                    className="text-base font-Light tracking-wide mt-2 
