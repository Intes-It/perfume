                ...
                <div>
                  <div className="grid grid-cols-2">
                    <div className="flex flex-col mr-6">
                      ...
                      <input
                        ...
                        type="text"
                        id="dif_first_name"
                        className={`px-4 py-3 border ${errors.dif_first_name ? 'border-red-700' : 'border-gray-300'} text-black`}
                      />
                    </div>
                    <div className="flex flex-col ml-6">
                      ...
                      <input
                        ...
                        type="text"
                        id="dif_last_name"
                        className={`px-4 py-3 border ${errors.dif_last_name ? 'border-red-700' : 'border-gray-300'} text-black`}
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col">
                    ...
                    <select data-te-select-init data-te-select-filter="true"
                      ...
                      id="dif_country"
                      className={`px-4 py-3 border ${errors.dif_country ? 'border-red-700' : 'border-gray-300'} text-black`}
                      onChange={(event) => {
                  ...
                  <div className="flex flex-col">
                    ...
                    <input
                      ...
                      type="text"
                      id="dif_ward"
                      className={`px-4 py-3 border ${errors.dif_ward ? 'border-red-700' : 'border-gray-300'} text-black`}
                    />
                    <input
                      {...formik.getFieldProps('dif_district')}
                      type="text"
                      id="dif_district"
                      className={`px-4 py-3 mt-4 border ${errors.dif_district ? 'border-red-700' : 'border-gray-300'} text-black`}
                    />
                  </div>
                  <div className="flex flex-col">
                    <label className="font-semibold">
                    ...
                    <input
                      ...
                      type="text"
                      id="dif_province"
                      className={`px-4 py-3 border ${errors.dif_province ? 'border-red-700' : 'border-gray-300'} text-black`}
                    />
                  </div>
                </div>
              ) : (
